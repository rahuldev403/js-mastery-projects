...
const Hero = () => {
  return (
    <main className='relative w-full h-screen overflow-hidden flex justify-center mb-[10%]'>
      <video src="public\videos\hero.mp4" autoPlay
        loop
        muted
        playsInline
      ...
      <div className='absolute bottom-[15%] flex flex-col gap-4 items-center'>
        <img src="public/images/illu-text.png" alt="illu" className='md:w-[30rem] w-[20rem]' />
        ...
        <div className='flex items-center gap-5 text-3xl font-extrabold text-gray-200'>
          <img src="public\images\illu-logo.png" alt="" className='md:h-16 h-12' /><h1>LEVEL-403</h1>
        </div>
        <p className='max-w-[80%] text-center text-[#babaff]'>
          Notice - Illuvium Games are in Beta Particiaption involves risk. Read our full Disclaimer here.
        </p>
      </div>
